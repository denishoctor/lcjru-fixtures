...
export const VENUES = {
  ...
  'Cliff Oval':                      { suburb: 'North Wahroonga', mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Cliff+Oval+Cliff+Ave%2C+North+Wahroonga+NSW+2076%2C+Australia' },
  ...
  'Forestville War Memorial':        { suburb: 'Forestville',     mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Forestville+War+Memorial+Playing+Fields%2C+Melwood+Ave%2C+Forestville+NSW+2087%2C+Australia' },
  ...
  'Nepean Rugby Park':               { suburb: 'Penrith',         mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Nepean+Rugby+Park%2C+78A+Andrews+Rd%2C+Penrith+NSW+2750%2C+Australia' },
  ...
  'Pennant Hills':                   { suburb: 'Pennant Hills',   mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Pennant+Hills+Park%2C+Pennant+Hills+NSW+2120%2C+Australia' },
  ...
  'Soldiers Memorial Park':          { suburb: 'East Lindfield',  mapsUrl: 'https://www.google.com/maps/search/?api=1&query=Soldiers+Memorial+Park%2C+Tryon+Rd%2C+East+Lindfield+NSW+2070%2C+Australia' },
